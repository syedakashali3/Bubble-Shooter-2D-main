...
public class LevelManager : MonoBehaviour
{
	...
	{
		GameManagerLevelsNew.instance.WinMenu.SetActive(false);
		StartLevel(currentLevel + 1);
	}

	public void RestartLevel()
	{
		GameManagerLevelsNew.instance.LoseMenu.SetActive(false);
		StartLevel(currentLevel);
	}

	public void StartNewGame()
	{
		GameManagerLevelsNew.instance.startUI.SetActive(false);
		GameManagerLevelsNew.instance.levelsUI.SetActive(true);
	}
	...
	System.Collections.IEnumerator LoadLevel(int level)
	{
		...
		GameManagerLevelsNew.instance.shootScript.CreateNewBubbles();
	}

	public void StartLevel(int level)
	{
		GameManagerLevelsNew.instance.levelsUI.SetActive(false);
